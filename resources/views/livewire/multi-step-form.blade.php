     ...
     <form wire:submit.prevent="register">
                         ...
                         <div class="col-md-6">
                             <div class="form-group">
                                 <label for="">Gender</label><br>
                                        ...
                                        <input type="radio" wire:model="gender" value="male"> Male<br>
					<input type="radio" wire:model="gender" value="female"> Female<br>
         ...
         <div class="step-three">
             <div class="card">
                 ...
                 <div class="card-body">
                     Which framework did you like working with the most whether it be its easy interface, quick response or its easy hosting. Totally on you. Just choose any one of the two mentioned below?
         ...
         <div class="step-four">
             <div class="card">
                 ...
                 <div class="card-body">
                     Any contributions you would like to provide us in any form of code or any comments you would like to share with me will highly be appreciated, just write it in any .txt file and upload it to me!
                     <div class="form-group">
                         <label for="cv">Upload_below</label>
